...
sudo docker login $appname.azurecr.io -u $appname -p $passwd
...
az webapp config ssl bind --certificate-thumbprint 0EBB5CED89D08DAEAABD9D9E4C04D02BED6E69DA -n $appname -g $appname --ssl-type SNI
