...
wget -qO- $pluginurl/polylang.2.8.4.zip -O $tmppluginzip && unzip -q $tmppluginzip -d $pluginspath && rm $tmppluginzip
...
mv /tmp/cropped-cropped-Smart-Forms-On-Demand-Favicon*.png $wpcontentpath/uploads/2018/10
